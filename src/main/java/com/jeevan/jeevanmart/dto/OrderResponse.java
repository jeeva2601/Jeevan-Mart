    ...
    public static OrderResponse fromOrder(Order order, List<?> items) {
        ...
        if (items != null) {
            for (Object obj : items) {
                ...
                } else if (obj instanceof com.jeevan.jeevanmart.model.OrderItem) {
                    responseItems.add(OrderItemResponse.fromOrderItem((com.jeevan.jeevanmart.model.OrderItem) obj));
                }
            }
        }
