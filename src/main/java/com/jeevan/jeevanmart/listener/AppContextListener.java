...
public class AppContextListener implements ServletContextListener {
    ...
    public static final String DATASOURCE_ATTR = "jeevanmart.datasource";
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        config.setJdbcUrl(props.getProperty("db.url", "jdbc:h2:tcp://localhost:9092/./data/jeevanmart"));
        ...
        config.setPoolName("JeevanMartPool");
