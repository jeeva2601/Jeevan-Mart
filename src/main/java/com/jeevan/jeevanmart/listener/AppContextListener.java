...
import com.jeevan.jeevanmart.util.DatabaseMigrationRunner;
import com.jeevan.jeevanmart.util.DatabaseUtil;
...
public class AppContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        logger.info("Initializing JeevanMart Application Context and HikariCP connection pool...");
        try {
            ...
            if (jdbcUrl == null || jdbcUrl.trim().isEmpty()) {
                jdbcUrl = props.getProperty("db.url", "jdbc:h2:mem:jeevanmart;DB_CLOSE_DELAY=-1;MODE=PostgreSQL");
            }
            ...
            config.setPoolName("JeevanMartHikariPool");
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        logger.info("Closing JeevanMart HikariCP connection pool...");
