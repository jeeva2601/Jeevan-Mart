...
import com.jeevan.jeevanmart.exception.UnauthorizedException;
import com.jeevan.jeevanmart.exception.ValidationException;
import com.jeevan.jeevanmart.filter.AuthFilter;
import com.jeevan.jeevanmart.listener.ServiceRegistry;
import com.jeevan.jeevanmart.model.User;
import com.jeevan.jeevanmart.util.JsonUtil;
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (METHOD_PATCH.equalsIgnoreCase(req.getMethod())) {
            try {
                ...
                handleError(resp, new com.jeevan.jeevanmart.exception.DataAccessException("Unhandled error", e));
            }
            return;
        }
