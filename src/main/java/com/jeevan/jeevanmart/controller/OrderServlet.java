package com.jeevan.jeevanmart.controller;
...
import com.jeevan.jeevanmart.dto.OrderResponse;
...
import com.jeevan.jeevanmart.model.OrderItem;
...
public class OrderServlet extends BaseServlet {
    ...
    private com.jeevan.jeevanmart.service.CartService cartService;
    ...
    public OrderServlet(OrderService orderService, com.jeevan.jeevanmart.service.CartService cartService) {
        this.orderService = orderService;
    ...
    public void init() {
        ...
        if (this.cartService == null) {
            this.cartService = new com.jeevan.jeevanmart.service.impl.CartServiceImpl(new CartDAOImpl(), new ProductDAOImpl());
        }
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if ("/checkout".equals(servletPath)) {
                if (cartService != null) {
                    List<com.jeevan.jeevanmart.dto.CartItemDTO> cartItems = cartService.getCart(user.getId());
