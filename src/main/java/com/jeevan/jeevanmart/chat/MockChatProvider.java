package com.jeevan.jeevanmart.chat;
...
public class MockChatProvider implements ChatProvider {
    ...
    static {
        ...
        FAQ.put("seller", "To sell on JeevanMart, register with the Seller role and add listings from your seller dashboard.");
    ...
    private String defaultReply() {
        return "I can help with questions about products, orders, shipping, returns, and reviews on JeevanMart. "
