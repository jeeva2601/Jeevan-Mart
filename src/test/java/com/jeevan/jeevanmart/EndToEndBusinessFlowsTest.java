...
public class EndToEndBusinessFlowsTest {
    ...
    void testBuyerAuth() throws Exception {
        ...
        String form = "email=buyer1@jeevanmart.com&password=buyer123&_csrf=" + csrf;
    ...
    void testSellerAuth() throws Exception {
        ...
        String form = "email=seller1@jeevanmart.com&password=seller123&_csrf=" + csrf;
    ...
    void testAdminAuth() throws Exception {
        ...
        String form = "email=admin@jeevanmart.com&password=admin123&_csrf=" + csrf;
    ...
    void testAdminUsers() throws Exception {
        ...
        assertEquals(200, res.status);
        assertTrue(res.body.contains("Registered Accounts"));
        assertTrue(res.body.contains("buyer1@jeevanmart.com"));
        assertTrue(res.body.contains("seller1@jeevanmart.com"));
    }
