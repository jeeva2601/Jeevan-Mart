...
import com.jeevan.jeevanmart.dto.PaginatedResult;
import com.jeevan.jeevanmart.dto.ProductDTO;
...
class AdminServletTest {
    ...
    void testAdminDashboardApi() throws Exception {
        when(request.getRequestURI()).thenReturn("/jeevanmart/api/admin/dashboard");
    ...
    void testGetAdminUsersApi() throws Exception {
        when(request.getRequestURI()).thenReturn("/jeevanmart/api/admin/users");
