...
class UserDAOTest extends BaseDAOTest {
    ...
    void testSaveAndFindUser() throws DatabaseException {
        User user = new User();
        user.setName("Jeevan Test");
        user.setEmail("jeevan@test.com");
        ...
        Optional<User> foundByEmail = userDAO.findByEmail("jeevan@test.com");
        assertTrue(foundByEmail.isPresent());
        assertEquals("Jeevan Test", foundByEmail.get().getName());
        ...
        assertEquals("jeevan@test.com", foundById.get().getEmail());
    }
