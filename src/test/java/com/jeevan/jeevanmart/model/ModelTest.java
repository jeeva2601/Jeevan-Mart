...
class ModelTest {
    ...
    void testUserModel() {
        ...
        User user = new User(1L, "Jeevan User", "jeevan@test.com", "super_secret_bcrypt_hash", Role.SELLER, true, now);

        assertEquals(1L, user.getId());
        assertEquals("Jeevan User", user.getName());
        assertEquals("jeevan@test.com", user.getEmail());
        ...
        User user2 = new User(1L, "Jeevan User", "jeevan@test.com", "other_hash", Role.SELLER, true, now);
        ...
        assertTrue(toString.contains("Jeevan User"));
        assertTrue(toString.contains("jeevan@test.com"));
    }
