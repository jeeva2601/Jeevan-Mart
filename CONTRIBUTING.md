...
This document outlines the workflow, coding standards, and branch strategy for contributing to the **JeevanMart** project.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/your-username/JeevanMart.git
   cd JeevanMart
   ```
