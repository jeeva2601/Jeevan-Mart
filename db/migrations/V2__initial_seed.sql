-- ==========================================================
-- JeevanMart — Migration V2: Initial Seed Data
-- Created: 2026-09-20
-- ==========================================================
...
INSERT INTO users (name, email, password_hash, role) VALUES
  ('Admin Jeevan',       'admin@jeevanmart.com',   '$2a$12$qKzk6H7WGdb2WVpX3bKQmOG9DhO7DnpWKM/Aapv1MW1ylFiwrQkre', 'ADMIN'),
  ('Jeevan Electronics', 'seller1@jeevanmart.com', '$2a$12$M6a7NKDtDAoxaoohwBHYOuQTz0NU7PTZYrMPx17Zg2iUVXhM6b0SW', 'SELLER'),
  ('BookWorld Store',     'seller2@jeevanmart.com', '$2a$12$M6a7NKDtDAoxaoohwBHYOuQTz0NU7PTZYrMPx17Zg2iUVXhM6b0SW', 'SELLER'),
  ('Alice Buyer',         'buyer1@jeevanmart.com',  '$2a$12$2PLRursg3L62LU/8ALbIauXz7bAZM6jlXfqiXq33VO1C1ttFavB6u', 'BUYER'),
  ('Bob Buyer',           'buyer2@jeevanmart.com',  '$2a$12$2PLRursg3L62LU/8ALbIauXz7bAZM6jlXfqiXq33VO1C1ttFavB6u', 'BUYER');
...
INSERT INTO products (seller_id, name, description, price, stock_qty, category, image_url) VALUES
  (2, 'Mechanical Keyboard',
   ...
   'https://images.unsplash.com/photo-xENSpRMPN-g?w=500'),
...
INSERT INTO products (seller_id, name, description, price, stock_qty, category, image_url) VALUES
  (3, 'Ceramic Coffee Mug (400 ml)',
   ...
   18.00, 80, 'Home',
   'https://images.unsplash.com/photo-ct1Usm9t4_c?w=500'),
...
INSERT INTO products (seller_id, name, description, price, stock_qty, category, image_url) VALUES
  (2, 'Cotton Graphic Tee - Developer Edition',
   ...
   22.00, 100, 'Clothing',
   'https://images.unsplash.com/photo-RsJDUzKdBws?w=500');
